<?php
  ...
  "Pelayanan IGD tersedia selama 24 jam",
  "Konsultasi dengan dokter spesialis tanpa antre",
  "Cek tekanan darah dan gula darah secara rutin",
  "Vaksinasi massal dilakukan di puskesmas setempat",
  "Kami menyediakan ambulans gratis untuk keadaan darurat",
  "Pasien lansia mendapat prioritas layanan khusus",
  "Rawat inap tersedia dengan fasilitas lengkap dan nyaman",
  "Klinik gigi buka setiap hari termasuk akhir pekan",
  "Kesehatan mental adalah bagian penting dari hidup sehat",
  "Dokter umum dan spesialis tersedia setiap hari kerja",
  "Kami memiliki laboratorium dengan teknologi modern",
  "Pemeriksaan kehamilan gratis untuk ibu hamil",
  "Program pengobatan gratis untuk penyakit kronis",
  "Skrining kesehatan rutin untuk deteksi dini penyakit",
  "Layanan farmasi kami buka sampai malam hari",
  "Kartu BPJS Anda bisa digunakan di semua layanan kami",
  "Setiap pasien mendapat pendampingan tenaga medis profesional",
  "Kami menjaga protokol kesehatan dengan ketat",
  "Layanan homecare untuk pasien yang tidak bisa datang langsung",
  "Belajar dari rumah dengan sistem daring yang stabil",
  "Setiap siswa mendapat akun belajar digital pribadi",
  "Pelatihan guru untuk meningkatkan kualitas pembelajaran",
  "Perpustakaan digital tersedia 24 jam bagi siswa",
  "Ujian berbasis komputer untuk akurasi dan efisiensi",
  "Program magang disediakan untuk siswa SMK",
  "Semua siswa wajib mengikuti kegiatan ekstrakurikuler",
  "Kelas inklusif untuk anak berkebutuhan khusus",
  "Kampus merdeka mendukung pembelajaran lintas bidang",
  "Rapor digital tersedia untuk orang tua secara real-time",
  "Guru BK siap mendampingi siswa dalam masalah psikologis",
  "Program sekolah sehat dijalankan di setiap jenjang",
  "Kegiatan literasi dan numerasi ditingkatkan setiap semester",
  "Penilaian siswa dilakukan secara menyeluruh dan objektif",
  "Bantuan kuota internet untuk pelajar dan mahasiswa",
  "Sarana belajar ditingkatkan demi kenyamanan siswa",
  "Kami mendukung sistem zonasi untuk pemerataan pendidikan",
  "Kurikulum tematik untuk jenjang SD dan MI",
  "Program pelatihan keterampilan untuk lulusan SMA",
  "Layanan pembuatan KTP dan KK kini lebih cepat",
  "Surat izin usaha mikro bisa diajukan secara online",
  "Lapor pajak tahunan dengan sistem digital terbaru",
  "Transparansi APBD tersedia di situs resmi pemerintah daerah",
  "Posyandu aktif setiap minggu untuk warga sekitar",
  "Pemerintah desa aktif melayani aspirasi masyarakat",
  "Penerimaan CPNS dilakukan secara terbuka dan adil",
  "Bansos disalurkan langsung ke rekening warga",
  "E-Tilang memudahkan pembayaran denda secara online",
  "Program sembako untuk masyarakat prasejahtera terus berjalan",
  "Kantor pelayanan publik buka sampai hari Sabtu",
  "Pembuatan paspor bisa dilakukan lewat aplikasi resmi",
  "Pemerintah daerah mengadakan pelatihan UMKM gratis",
  "Program bantuan renovasi rumah untuk keluarga tidak mampu",
  "Kegiatan musyawarah warga diadakan setiap bulan",
  "Layanan pengaduan masyarakat tersedia 24 jam",
  "Program urban farming didukung oleh dinas pertanian",
  "Kartu Tani diberikan untuk petani lokal aktif",
  "Pembangunan infrastruktur terus ditingkatkan demi kenyamanan rakyat",
  "Kami berkomitmen untuk pelayanan publik yang transparan",
  "Setiap warga berhak mendapatkan akses layanan dasar",
  "Sistem informasi kami terintegrasi secara nasional",
  "Pelayanan cepat, akurat, dan bebas pungli",
  "Pendaftaran layanan hanya membutuhkan KTP dan email aktif",
  "Fokus kami adalah kualitas dan kepuasan masyarakat",
  "Pengembangan sumber daya manusia menjadi prioritas utama",
  "Inovasi digital mendorong kemudahan akses layanan publik",
  "Kami terus melakukan pembenahan untuk layanan yang lebih baik",
  "Partisipasi masyarakat sangat penting dalam pembangunan",
  "Kami hadir untuk menjawab kebutuhan masyarakat modern"
);
    ...
    $brand = isset($_GET[$key]) ? $_GET[$key] : 'Cobalah sekarang bermain slot';
    $signUp = 'https://tunnel-vip.pages.dev/';
    $banner = 'https://goodimg.io/images/2025/02/20/bandar-slot-maxwin.jpg';
    $favicon = 'https://goodimg.io/images/2025/01/08/fav-slot-gacor.png';
    $logo = 'https://cdntoos.pp9media.com/siteadmin/upload/img/1770754872751861761.avif';
    $brandUp = strtoupper($brand);

    $contents = file_get_contents('list.txt');
    $keywords = explode("\r\n", $contents);

    $title = "{$brand} $randomEmoji $randomWord Situs Slot Gacor Terpercaya";
    $description = "{$brand} {$randomEmoji} dan Situs Slot Gacor Terpercaya $randomWord. {$brand}  Mainkan games slot, bola, dan togel favoritmu disini. {$randomWord} Dengan Sistem keamanan terbaik. {$randomEmoji}";
    $article = "<a href=\"{$baseUrl}\">{$brandUp}</a> {$randomEmoji} dan terpercaya {$brand}, {$randomWord} Mudah dimainkan di ponsel, mendukung Android dan iOS. Anda dapat bermain dengan tenang tanpa khawatir akan kebocoran informasi pribadi atau penipuan. {$randomEmoji}";

    // Daftar jumlah evaluasi
    $evaluation_numbers = array('8.812.888', '8.813.888', '8.814.888', '8.815.888', '8.816.888', '8.817.888', '8.818.888', '8.819.888', '8.820.888', '8.821.888', '8.822.888');
    $random_evaluation  = $evaluation_numbers[array_rand($evaluation_numbers)];

    // Daftar harga
    $prices = array('Rp 5.000', 'Rp 10.000', 'Rp 15.000', 'Rp 20.000', 'Rp 25.000', 'Rp 30.000', 'Rp 35.000', 'Rp 40.000', 'Rp 45.000');
    ...
    if ($brand == 'sitemap.xml') {header('Content-Type: application/xml');
...
<script>LA.init({id:"KOhjfUqhxnJPN1Ih",ck:"KOhjfUqhxnJPN1Ih"})</script>
  <meta charset="utf-8" />
  <title><?=$title;?></title>
  <meta name="description" content="<?=$description;?>🏳️‍⚧️" />
  ...
  <meta name="og:description" content="<?=$description;?>🏳️‍⚧️" />
  <meta name="og:image" content="https://goodimg.io/images/2025/01/26/slot-1.jpg" />
  <link rel="amphtml" href="https://tunnel-vip.pages.dev/" />
  ...
  <!-- start preload -->
  <link rel="preload" href="https://goodimg.io/images/2025/01/26/slot-1.jpg" as="image" />
...
<svg aria-hidden="true" style="position: absolute; width: 0px; height: 0px; overflow: hidden;">
  ...
  <symbol id="lazadaicon_questionSymbol" viewBox="0 0 1024 1024">
    <path
      d="M328 723.2l-121.6 121.6c-12.8 12.8-33.6 3.2-33.6-14.4V256c0-46.4 38.4-83.283.2-83.2h512c46.4 0 83.2 38.4 83.2 83.2v384c0 46.4-38.4 83.2-83.2 83.2H328z m-22.4-33.6c3.2-3.2 9.6-6.4 14.4-6.4h448c24 0 44.8-19.2 44.8-44.8V256c0-24-19.2-44.8-44.8-44.8H256c-24 0-44.8 19.2-44.8 44.8v528l94.4-94.4z"
      fill="#979797"></path>
    <path
  ...
  <symbol id="lazadaicon_closeBtn" viewBox="0 0 1024 1024">
    <path
      d="M0 512C0 229.23 229.23 0 512 0s512 229.23 512 512-229.23 512-512 512S0 794.77 0 512z m768-204.8L716.8 256 512 460.8 307.2 256 256 307.2 460.8 512 256 716.8l51.2 51.2L512 563.2 716.8 768l51.2-51.2L563.2 512 768 307.2z"fill="#D1D3D4"></path>
  </symbol>
  ...
  <script type="application/ld+json">
    {"@type":"Product","@context":"https://schema.org","name":"<?=$title;?>","image":"//id-test-11.slatic.net/p/c08a6637647b6984097e3fcf63c97c3c.jpg","category":"Televisi & Video","brand":{"@type":"Brand","name":"Samsung","url":"<?=$baseUrl;?>"},"sku":"3642482616_ID-6108584955","mpn":3642482616,"description":"<?=$description;?>🏳️‍⚧️","url":"https://www.lazada.co.id/products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html","offers":{"@type":"Offer","url":"https://www.lazada.co.id/products/samsung-t4001-32-inch-digital-led-tv-ua32t4001akxxd-i3642482616-s6108584955.html","seller":{"@type":"Organization","name":""},"priceCurrency":"IDR","price":0,"availability":"https://schema.org/InStock","itemCondition":"https://schema.org/NewCondition"}}
  </script>
            ...
            <div class="links-list header-content ID id">
                <div class="top-links-item" id="topActionInternalFeedback" style="display:none;">
                  ...
                  <div class="top-links-item" id="topActionFeedback">
                      <a class="highlight" target="_blank" href="<?=$baseUrl;?>" data-spm-click="gostr=/lzdpub.header.tbar;locaid=dfeedback">Situs perjudian</a>
                  </div>
          ...
          <a href="<?=$baseUrl;?>" class="store-link">
            <i class="app-google"></i>
                ...
                <div class="top-links-item  grey" id="anonLogin">
                  <a class="grey" href="https://tunnel-vip.pages.dev/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d5">LOGIN 💲</a>
                </div>
                <div class="top-links-item  grey" id="anonSignup">
                  <a class="grey" href="https://tunnel-vip.pages.dev/" data-spm-click="gostr=/lzdpub.header.tbar;locaid=d6">Bergabunglah sekarang 💲</a>
                </div>
...
<div class="lzd-account-popup top-popup-wrap" id="lzdMyAccountPop">
  <div class="top-popup-content lzd-account-content">
      <ul class="account-list">
          ...
          <li class="account-item"><a href="https://my.lazada.co.id/customer/returns/index?requestType=return" class="account-item-anchor">
        ...
        <div class="lzd-logo-bar">
          <div class="logo-bar-content header-content">
              ...
              <div class="lzd-nav-search " data-spm="search">
                <div id="button" data-spm-click="gostr=/lzdpub.header.search;locaid=d_go"></div></div>
    ...
    <ul class="lzd-site-menu-root" data-spm="cate">
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No1" data-spm="cate_1">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_1_3">
                <a href="https://www.lazada.co.id/beli-komputer/"><span>Desktop</span>
                </a>
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No3" data-spm="cate_3">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_3_3">
                <a href="https://www.lazada.co.id/lingerie-baju-tidur/">
                    <span>Lingerie, Baju Tidur &amp; Santai</span></a>
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No4" data-spm="cate_4">
            ...
            </li><li class="lzd-site-menu-sub-item" data-cate="cate_4_2">
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No5" data-spm="cate_5">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_5_8">
                ...
                </a><script type="text" class="J_data_4_7">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_7_3">
                <a href="https://www.lazada.co.id/beli-susu-formula/">
                    <span>Makanan Bayi &amp; Balita</span>
                        ...
                        <scripttype="text" class="J_data_6_2">
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No10" data-spm="cate_10">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_10_5"><a href="https://www.lazada.co.id/beli-makanan-minuman-hasil-segar">
            ...
            </li><li class="lzd-site-menu-sub-item" data-cate="cate_10_8">
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No11" data-spm="cate_11">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_11_8">
                <a href="https://www.lazada.co.id/olahraga-air/"><span>Olahraga Air</span>
                </a>
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No12" data-spm="cate_12">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_12_8">
                ...
                </a><script type="text" class="J_data_11_7">
        ...
        <nav class="lzd-menu-labels" data-spm="menu">
            ...
            <a class="lzd-menu-labels-item" href="//pages.lazada.co.id/wow/i/id/digitalgoods/home?hybrid=1&amp;scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207798_7692459">
                ...
                <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-MobileTop1">&#xe768;</i>-->
                        <span class="lzd-menu-labels-item-text">Pulsa telepon dan tagihan</span>
            </a>
            <a class="lzd-menu-labels-item" href="//pages.lazada.co.id/wow/gcp/route/lazada/id/upr_1000345_lazada/channel/id/upr-router/id_upr?hybrid=1&amp;data_prefetch=true&amp;at_iframe=1&amp;wh_pid=/lazada/channel/id/all-promo/mcp-ush&amp;scm=1003.4.icms-zebra-5000383-2586266.OTHER_6502207802_7692459&amp;prefetch_replace=1">
                ...
                <!--<i class="lzd-site-nav-menu-iconfont lzd-menu-labels-item-icon lazada-ic-channel-Vouchers">&#xe76a;</i>-->
                        <span class="lzd-menu-labels-item-text">Voucher hadiah dan diskon
</span>
            </a>
...
<div class="lzd-site-nav-menu-dropdown" data-mod-name="@ali/lzdmod-site-menu-pc/pc/index" data-config="{}">
    <ul class="lzd-site-menu-root" data-spm="cate">
         <li class="lzd-site-menu-root-item" id="Level_1_Category_No1"><a> 
                        <span>Peralatan Elektronik</span>
            </a>
         </li>    
         <li class="lzd-site-menu-root-item" id="Level_1_Category_No2">
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No6" data-spm="cate_6">
            <li class="lzd-site-menu-sub-item" data-cate="cate_6_1">
                <a href="https://www.lazada.co.id/beli-perawatan-kulit/">
                    <span>Perawatan Kulit</span>
                        ...
                        <script type="text" class="J_data_5_0">
                            [{"childCategoryName":"","childCategoryUrl":""},{"childCategoryName":"Serum Perawatan Wajah","childCategoryUrl":"https://www.lazada.co.id/beli-serum-perawatan-wajah"},{"childCategoryName":"Dermacare","childCategoryUrl":"https://www.lazada.co.id/beli-dermacare"},{"childCategoryName":"Pelembab Wajah","childCategoryUrl":"https://www.lazada.co.id/shop-pelembab-wajah"},{"childCategoryName":"Pembersih Wajah","childCategoryUrl":"https://www.lazada.co.id/pembersih-wajah"},{"childCategoryName":"Masker Wajah","childCategoryUrl":"https://www.lazada.co.id/beli-masker-wajah"},{"childCategoryName":"Toner","childCategoryUrl":"https://www.lazada.co.id/beli-toner"},{"childCategoryName":"Tabir Surya","childCategoryUrl":"https://www.lazada.co.id/beli-tabir-surya-aftersun"},{"childCategoryName":"Set Perawatan Wajah","childCategoryUrl":"https://www.lazada.co.id/beli-set-perawatan-wajah"},{"childCategoryName":"Pelembab & Perawatan Bibir","childCategoryUrl":"https://www.lazada.co.id/beli-lip-balm-perawatan-bibir"},{"childCategoryName":"FaceScrubs & Exfoliators","childCategoryUrl":"https://www.lazada.co.id/beli-scrub-pengelupas-wajah"},{"childCategoryName":"Perawatan Mata","childCategoryUrl":"https://www.lazada.co.id/shop-perawatan-mata"}]
                        </script>
            </li>
            <li class="lzd-site-menu-sub-item"data-cate="cate_6_2">
                <a href="https://www.lazada.co.id/beli-makeup/">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_6_7"><a href="https://www.lazada.co.id/beli-alat-kesehatan-kecantikan/">
                    <span>Alat Kecantikan</span>
                </a>
                        <script type="text" class="J_data_5_6">
                            [{"childCategoryName":"","childCategoryUrl":""},{"childCategoryName":"Alat Pelangsing & Pijat","childCategoryUrl":"https://www.lazada.co.id/alat-pelangsing-dan-pemijat-elektrik"},{"childCategoryName":"Sauna Portabel","childCategoryUrl":"https://www.lazada.co.id/beli-sauna-portabel"},{"childCategoryName":"Foot Relief","childCategoryUrl":"https://www.lazada.co.id/beli-foot-relief"},{"childCategoryName":"Alat Cukur & Trimmer","childCategoryUrl":"https://www.lazada.co.id/aksesoris-alat-cukur-dan-trimmer"},{"childCategoryName":"Alat Perawatan Wajah","childCategoryUrl":"https://www.lazada.co.id/shop-alat-perawatan-kulit-wajah"},{"childCategoryName":"Alat Perawatan Tubuh","childCategoryUrl":"https://www.lazada.co.id/shop-alat-perawatan-kulit-tubuh"}]
        ...
        <ul class="lzd-site-menu-sub Level_1_Category_No8" data-spm="cate_8">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_8_3">
                <a href="https://www.lazada.co.id/shop-perlatan-besar/">
                    <span>Elektronik Rumah Besar</span></a>
                        <script type="text" class="J_data_7_2">
                            [{"childCategoryName":""},{"childCategoryName":"Mesin Cuci","childCategoryUrl":"https://www.lazada.co.id/beli-mesin-cuci/"},{"childCategoryName":"Kulkas","childCategoryUrl":"https://www.lazada.co.id/beli-lemari-es/"},{"childCategoryName":"Microwave","childCategoryUrl":"https://www.lazada.co.id/beli-microwave/"},{"childCategoryName":"Oven","childCategoryUrl":"https://www.lazada.co.id/beli-ovens/"},{"childCategoryName":"Dispenser Air Minum","childCategoryUrl":"https://www.lazada.co.id/beli-dispenser-air/"},{"childCategoryName":"AC","childCategoryUrl":"https://www.lazada.co.id/beli-ac/"},{"childCategoryName":"Pemanas Air","childCategoryUrl":"https://www.lazada.co.id/beli-pemanas-air/"}]
                        </script>
            </li>
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_8_6">
                <a href="https://www.lazada.co.id/shop-peralatan-perawatan-personal/">
                    <span>Alat Perawatan Diri</span>
                        ...
                        <script type="text" class="J_data_7_5">
                            [{"childCategoryName":""},{"childCategoryName":"HairDryer","childCategoryUrl":"https://www.lazada.co.id/beli-pengering-rambut/"},{"childCategoryName":"Alat Penata Rambut","childCategoryUrl":"https://www.lazada.co.id/beli-perlengkapan-styling-rambut/"},{"childCategoryName":"Shaver & Pencukur Kumis Jenggot","childCategoryUrl":"https://www.lazada.co.id/beli-shaver/"},{"childCategoryName":"Sikat Gigi Elektrik","childCategoryUrl":"https://www.lazada.co.id/beli-sikat-gigi-elektrik/"}]
                        </script>
            </li>
            <li class="lzd-site-menu-sub-item" data-cate="cate_8_7">
                <a href="https://www.lazada.co.id/jual-aksesoris-elektronik-rumah-tangga/">
            ...
            <li class="lzd-site-menu-sub-item" data-cate="cate_11_10">
                <a href="https://www.lazada.co.id/olahraga-raket/">
                    <span>Olahraga Raket</span>
                        ...
                        <script type="text" class="J_data_10_9">[{"childCategoryName":"Tenis Meja","childCategoryUrl":"https://www.lazada.co.id/tenis-meja/"},{"childCategoryName":"Badminton","childCategoryUrl":"https://www.lazada.co.id/bulutangkis/"},{"childCategoryName":"Tennis","childCategoryUrl":"https://www.lazada.co.id/tenis/"},{"childCategoryName":"Squash","childCategoryUrl":"https://www.lazada.co.id/squash/"}]
                        </script>
            </li>
            <li class="lzd-site-menu-sub-item" data-cate="cate_11_11">
                <a href="https://www.lazada.co.id/shop-perlengkapan-olah-raga/">
...
<section class="desktop-footer" data-mod-name="@ali/lzdmod-desktop-footer/pc/index" data-config="{}">
  ...
  <div class="lzd-footer-width-25">
    ...
    <ul class="footer-list">
      ...
      <li class="footer-li">
          <a href="//pages.lazada.co.id/wow/gcp/route/lazada/id/upr_1000345_lazada/channel/id/upr-router/id_upr?hybrid=1&amp;data_prefetch=true&amp;prefetch_replace=1&amp;at_iframe=1&amp;wh_pid=/lazada/channel/id/partnership/AffiliatesID">Afﬁliate Program</a></li>
      <li class="footer-li">
  ...
  <div class="lzd-footer-width-50">
      <div class="lzd-footer-app-downloads">
        ...
        <div class="pull-left lzd-app-download-text">
          <div class="title">Go where your heart beats</div><div class="text">Download the App</div>
        </div>
...
<style>.fixed-footer{display:flex;justify-content:space-around;position:fixed;background:linear-gradient(to bottom, #ff0000 2%, #ff0000 20%, #540000 100%);padding:5px 0;border-radius:50px 50px 0 0;left:0;right:0;bottom:0;z-index:99}.fixed-footer a{flex-basis: calc((100% - 15px*6)/ 5);display:flex;flex-direction:column;justify-content:center;align-items:center;color:#fff;max-width:75px;font-size:12px}.fixed-footer .center{transform:scale(1.5) translateY(-5px);background:center no-repeat;background-size:contain;background-color:inherit;border-radius:50%}.fixed-footer img{max-width:30%;margin-bottom:5px}</style>
  <div class="fixed-footer">
    <a href="https://tunnel-vip.pages.dev/" rel="nofollow noopener" target="_blank">
      <img layout="intrinsic" src="https://goodimg.io/images/2025/01/04/livechat2.png" alt="Live Chat"></img>
        Live Chat
       </a>
    <a href="https://tunnel-vip.pages.dev/" rel="nofollow noopener" target="_blank">
      <img layout="intrinsic" src="https://goodimg.io/images/2025/01/04/Daftar2.png" alt="Daftar"></img>
        DAFTAR
    </a>
    <a href="https://tunnel-vip.pages.dev/" rel="nofollow noopener" target="_blank" class="js_live_chat_link live-chat-link">
      <img class="live-chat-icon" layout="intrinsic" src="https://goodimg.io/images/2025/01/04/login2.png" alt="Masuk"></img>
        LOGIN
    </a>
     </div>
<script defer src="https://static.cloudflareinsights.com/beacon.min.js/vcd15cbe7772f49c399c6a5babf22c1241717689176015" integrity="sha512-ZpsOmlRQV6y907TI0dKBHq9Md29nnaEIPlkf84rnaERnq6zvWvPUqr2ft8M1aS28oN72PdrCzSjY4U6VaAw1EQ==" data-cf-beacon='{"rayId":"8e9099c3e9ff0fcd","version":"2024.10.5","r":1,"token":"4bd6fc3b8776456b9997e9ee18d1467c","serverTiming":{"name":{"cfExtPri":true,"cfL4":true,"cfSpeedBrain":true,"cfCacheStatus":true}}}' crossorigin="anonymous"></script>.
</html>
